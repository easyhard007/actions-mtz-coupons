...
//   const matchAppJs = text.match(/https:\/\/[./_-\w]+app\.js(?=")/g)
  const matchAppJs = text.match(/app\.js/)
  console.log(matchAppJs)
  try {
    const globalData = JSON.parse(matchGlobal[1])
    
    return {
      gundamId: globalData.gdId,
      appJs: 'https://s3plus.meituan.net/v1/mss_91f3b645703642ce914d9ce3610eaf4c/gundampage/165519434506305f590f9d3c65deabe458d0803b6f80c/app.js'
    }
  } catch (e) {
