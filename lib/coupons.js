...
//   const matchAppJs = text.match(/https:\/\/[./_-\w]+app\.js(?=")/g)
  const matchAppJs = text.match(/https:\/\/[./_-\w]+app\.js/g)
  console.log(matchAppJs[0])
  try {
    const globalData = JSON.parse(matchGlobal[1])
    
    return {
      gundamId: globalData.gdId,
      appJs: 'https://s3plus.meituan.net/v1/mss_91f3b645703642ce914d9ce3610eaf4c/gundampage/165520670997310a680ac4c4c606fc0a81220c2a6921b/app.js'
    }
  } catch (e) {
